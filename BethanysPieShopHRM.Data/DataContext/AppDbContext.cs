...
namespace BethanysPieShopHRM.Data.DataContext
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //seed categories
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 1, CountryName = "Belgium" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 2, CountryName = "Germany" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 3, CountryName = "Netherlands" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 4, CountryName = "USA" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 5, CountryName = "Japan" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 6, CountryName = "China" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 7, CountryName = "UK" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 8, CountryName = "France" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 9, CountryName = "Brazil" });
